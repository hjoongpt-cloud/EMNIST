...
from src.models.trunk_j import TrunkJ
from src.models.expert_moe_k import MoELayer, LoadBalanceLoss, EntropyLoss

class ExpertModelJ(nn.Module):
    def __init__(self, cfg):
        super().__init__()
        self.trunk = TrunkJ(cfg)
